...
pub struct FindAvailableReservationsResponse {
    #[serde(rename = "availableReservations")]
    pub available_reservations: Vec<crate::models::AvailableReservation>,
...
impl FindAvailableReservationsResponse {
    pub fn new(
        available_reservations: Vec<crate::models::AvailableReservation>,
