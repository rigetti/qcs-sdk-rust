...
pub struct CheckClientApplicationRequest {
    /// Name of component
    #[serde(rename = "name")]
    pub name: String,
...
impl CheckClientApplicationRequest {
    pub fn new(name: String, version: String) -> CheckClientApplicationRequest {
        CheckClientApplicationRequest { name, version }
    }
}
