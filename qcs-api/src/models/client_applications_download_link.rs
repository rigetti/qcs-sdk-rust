...
pub struct ClientApplicationsDownloadLink {
    #[serde(
        rename = "checksumDescription",
        skip_serializing_if = "Option::is_none"
    )]
    pub checksum_description: Option<Box<crate::models::ChecksumDescription>>,
