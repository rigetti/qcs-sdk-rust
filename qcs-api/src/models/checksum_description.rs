...
pub struct ChecksumDescription {
...
impl ChecksumDescription {
    pub fn new(header_name: String, _type: Type) -> ChecksumDescription {
        ChecksumDescription { header_name, _type }
    }
}
