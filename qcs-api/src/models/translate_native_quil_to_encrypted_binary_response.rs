...
pub struct TranslateNativeQuilToEncryptedBinaryResponse {
    #[serde(rename = "memoryDescriptors", skip_serializing_if = "Option::is_none")]
    pub memory_descriptors:
        Option<::std::collections::HashMap<String, crate::models::ParameterSpec>>,
    /// Encrypted binary built for execution on the target quantum processor
    #[serde(rename = "program")]
    pub program: String,
    #[serde(rename = "roSources", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "settingsTimestamp", skip_serializing_if = "Option::is_none")]
    pub settings_timestamp: Option<String>,
}

impl TranslateNativeQuilToEncryptedBinaryResponse {
    pub fn new(program: String) -> TranslateNativeQuilToEncryptedBinaryResponse {
