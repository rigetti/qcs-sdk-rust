...
pub struct AuthEmailPasswordResetTokenRequest {
    #[serde(rename = "email")]
    pub email: String,
}

impl AuthEmailPasswordResetTokenRequest {
    pub fn new(email: String) -> AuthEmailPasswordResetTokenRequest {
        AuthEmailPasswordResetTokenRequest { email }
    }
}
