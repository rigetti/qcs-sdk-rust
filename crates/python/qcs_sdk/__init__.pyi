...
class RegisterData:
    ...
    def inner(
        ...
        Sequence[Sequence[int]], Sequence[Sequence[float]], Sequence[Sequence[complex]]
    ]:
    ...
    def as_i8(self) -> Optional[Sequence[Sequence[int]]]: ...
    def as_i16(self) -> Optional[Sequence[Sequence[int]]]: ...
    def as_f64(self) -> Optional[Sequence[Sequence[float]]]: ...
    def as_complex32(self) -> Optional[Sequence[Sequence[complex]]]: ...
    def to_i8(self) -> Sequence[Sequence[int]]: ...
    def to_i16(self) -> Sequence[Sequence[int]]: ...
    def to_f64(self) -> Sequence[Sequence[float]]: ...
    def to_complex32(self) -> Sequence[Sequence[complex]]: ...
    @staticmethod
