...
class RegisterMatrix:
    ...
    def to_integer(self) -> Optional[NDArray[np.int64]]: ...
    def to_real(self) -> Optional[NDArray[np.float64]]: ...
    def to_complex(self) -> Optional[NDArray[np.complex128]]: ...
    @staticmethod
...
class ResultData:
    ...
    def to_qvm(self) -> Optional[QVMResultData]: ...
    def to_qpu(self) -> Optional[QPUResultData]: ...
    @staticmethod
...
class ExecutionData:
    ...
    @result_data.setter
    def registers(self, result_data: ResultData): ...
    @property
