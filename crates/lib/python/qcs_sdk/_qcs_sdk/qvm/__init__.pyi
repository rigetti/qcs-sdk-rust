...
class QVMError(_qcs_sdk.QcsSdkError):
    r"""
...
class QVMResultData:
    ...
    """
    @property
    def memory(self) -> builtins.dict[builtins.str, _qcs_sdk.RegisterData]:
        r"""
        A map of register names (ie. "ro") to a `RegisterData` containing their values.
        """
    def __getnewargs__(self) -> tuple[builtins.dict[builtins.str, _qcs_sdk.RegisterData]]: ...
    def __new__(cls, memory: typing.Mapping[builtins.str, _qcs_sdk.RegisterData]) -> QVMResultData:
        r"""
    ...
    def __repr__(self) -> builtins.str:
        ...
        """
    @staticmethod
    def from_memory_map(memory: typing.Mapping[builtins.str, _qcs_sdk.RegisterData]) -> QVMResultData:
        r"""
