...
DEFAULT_COMPILER_TIMEOUT: typing.Final[builtins.float]
...
class CompilerOpts:
    ...
    """
    def __new__(
        cls, timeout: typing.Optional[builtins.float] = 30.0, protoquil: typing.Optional[builtins.bool] = None
    ) -> CompilerOpts:
        r"""
...
class NativeQuilMetadata:
    ...
    def __new__(
        cls,
        final_rewiring: typing.Optional[typing.Sequence[builtins.int]],
        gate_depth: typing.Optional[builtins.int],
        gate_volume: typing.Optional[builtins.int],
        multiqubit_gate_depth: typing.Optional[builtins.int],
        program_duration: typing.Optional[builtins.float],
        program_fidelity: typing.Optional[builtins.float],
        topological_swaps: typing.Optional[builtins.int],
        qpu_runtime_estimation: typing.Optional[builtins.float],
    ) -> NativeQuilMetadata:
        r"""
...
class QuilcError(_qcs_sdk.QcsSdkError):
    r"""
...
class RandomizedBenchmarkingRequest:
    ...
    def __new__(
        ...
        depth: builtins.int,
        qubits: builtins.int,
        gateset: typing.Sequence[builtins.str],
        seed: typing.Optional[builtins.int],
        interleaver: typing.Optional[builtins.str],
    ) -> RandomizedBenchmarkingRequest: ...
...
class TargetDevice:
    ...
    """
    @staticmethod
    def from_isa(isa: isa.InstructionSetArchitecture) -> TargetDevice:
        r"""
...
def compile_program(
    quil: builtins.str, target: TargetDevice, client: QuilcClient, options: typing.Optional[CompilerOpts] = None
) -> CompilationResult:
    r"""
...
def compile_program_async(
    quil: builtins.str, target: TargetDevice, client: QuilcClient, options: typing.Optional[CompilerOpts] = None
) -> collections.abc.Awaitable[CompilationResult]:
    r"""
    Compile a quil program for a target device.
...
def conjugate_pauli_by_clifford(
    request: ConjugateByCliffordRequest, client: QuilcClient
) -> ConjugatePauliByCliffordResponse:
    r"""
...
def conjugate_pauli_by_clifford_async(
    request: ConjugateByCliffordRequest, client: QuilcClient
) -> collections.abc.Awaitable[ConjugatePauliByCliffordResponse]:
    r"""
    Given a circuit that consists only of elements of the Clifford group, return its action on a PauliTerm.
    In particular, for Clifford C, and Pauli P, this returns the PauliTerm representing CPC^{\dagger}.
...
def generate_randomized_benchmarking_sequence(
    request: RandomizedBenchmarkingRequest, client: QuilcClient
) -> GenerateRandomizedBenchmarkingSequenceResponse:
    r"""
...
def generate_randomized_benchmarking_sequence_async(
    request: RandomizedBenchmarkingRequest, client: QuilcClient
) -> collections.abc.Awaitable[GenerateRandomizedBenchmarkingSequenceResponse]:
    r"""
    Construct a randomized benchmarking experiment on the given qubits, decomposing into
    gateset. If interleaver is not provided, the returned sequence will have the form
