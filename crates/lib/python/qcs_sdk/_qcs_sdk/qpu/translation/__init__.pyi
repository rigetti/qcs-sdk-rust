...
class TranslationError(_qcs_sdk.QcsSdkError):
    r"""
...
def get_quilt_calibrations(quantum_processor_id: builtins.str, client: typing.Optional[client.QCSClient] = None, timeout: typing.Optional[builtins.float] = None) -> builtins.str:
    r"""
...
def get_quilt_calibrations_async(quantum_processor_id: builtins.str, client: typing.Optional[client.QCSClient] = None, timeout: typing.Optional[builtins.float] = None) -> collections.abc.Awaitable[builtins.str]:
    r"""
    Retrieve the calibration data used for client-side Quil-T generation.
...
def translate(native_quil: builtins.str, num_shots: builtins.int, quantum_processor_id: builtins.str, client: typing.Optional[client.QCSClient] = None, translation_options: typing.Optional[TranslationOptions] = None) -> TranslationResult:
    r"""
...
def translate_async(native_quil: builtins.str, num_shots: builtins.int, quantum_processor_id: builtins.str, client: typing.Optional[client.QCSClient] = None, translation_options: typing.Optional[TranslationOptions] = None) -> collections.abc.Awaitable[TranslationResult]:
    r"""
    Translates a native Quil program into an executable program.
