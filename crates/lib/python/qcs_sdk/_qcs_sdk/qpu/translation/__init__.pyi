...
class Riverlane:
    ...
    def __new__(
        cls,
        qeci_configuration_data: typing.Mapping[builtins.str, typing.Sequence[builtins.int]],
        qeci_max_nanoseconds_until_read_available: builtins.int,
    ) -> Riverlane: ...
...
class TranslationOptions:
    ...
    def v2(
        *,
        prepend_default_calibrations: typing.Optional[builtins.bool] = None,
        passive_reset_delay_seconds: typing.Optional[builtins.float] = None,
        allow_unchecked_pointer_arithmetic: typing.Optional[builtins.bool] = None,
        allow_frame_redefinition: typing.Optional[builtins.bool] = None,
    ) -> TranslationOptions:
        r"""
...
def get_quilt_calibrations_async(
    quantum_processor_id: builtins.str,
    client: typing.Optional[client.QCSClient] = None,
    timeout: typing.Optional[builtins.float] = None,
...
def translate(
    native_quil: builtins.str,
    num_shots: builtins.int,
    quantum_processor_id: builtins.str,
    client: typing.Optional[client.QCSClient] = None,
    translation_options: typing.Optional[TranslationOptions] = None,
) -> TranslationResult:
    r"""
...
def translate_async(
    ...
    client: typing.Optional[client.QCSClient] = None,
    translation_options: typing.Optional[TranslationOptions] = None,
) -> collections.abc.Awaitable[TranslationResult]:
    r"""
    Translates a native Quil program into an executable program.
